...
% b-matrix conversion
EDTI.b_Matrix_from_bval_bvec('data.bval');
...
EDTI.FlipPermuteSpatialDimensions('nii_file','data.nii','flip',[0 1 0],'permute',[1 2 3]);
EDTI.FlipPermuteSpatialDimensions('nii_file','nodif_brain_mask.nii','flip',[0 1 0],'permute',[1 2 3]);
...
EDTI.PerformDTI_DKIFit('nii_file','data_FP.nii','grad_perm',2,'grad_flip',2,...
    'fit_mode','ols','mask','nodif_brain_mask_FP.nii','txt_file','data.txt');

% Perform CSD to derive the Fiber Orientation Distribution (FOD)
EDTI.PerformCSD('mat_file','data_FP.mat','output','data_FP_CSD_FOD.nii','mscsd',0);
% Perform CSD-Based fiber tractography
EDTI.PerformFODBased_FiberTracking('mat_file','data_FP.mat','fod_file','data_FP_CSD_FOD.nii',...

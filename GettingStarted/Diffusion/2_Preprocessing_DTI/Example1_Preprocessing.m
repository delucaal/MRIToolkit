...
MRTQuant.b_Matrix_from_bval_bvec('bval_file','sub-MRI_ses-1/dwi/sub-MRI_ses-1_dMRI_B2500_S15_MB2_v2_1.bval',...
...
MRTQuant.ResampleDataSpatially('nii_file','sub-MRI_ses-1/anat/sub-MRI_ses-1_sT1W_3D_TFE_1_brain_FP.nii'...
    ...
    'res',[2 2 2]);
% Diffusion after
MRTQuant.FlipPermuteSpatialDimensions('nii_file','sub-MRI_ses-1/dwi/sub-MRI_ses-1_dMRI_B2500_S15_MB2_v2_1.nii',...
...
% MRTQuant.PerformSignalDriftCorrection('nii_file','sub-MRI_ses-1/dwi/sub-MRI_ses-1_dMRI_B2500_S15_MB2_v2_1_FP.nii',...
...
% MRTQuant.PerformGibbsRingingCorrection('nii_file','sub-MRI_ses-1/dwi/sub-MRI_ses-1_dMRI_B2500_S15_MB2_v2_1_FP_denoised.nii',...
...
MRTQuant.PerformDTI_DKIFit('nii_file','sub-MRI_ses-1/dwi/sub-MRI_ses-1_dMRI_B2500_S15_MB2_v2_1_FP_denoised.nii',...
    'txt_file','sub-MRI_ses-1/dwi/sub-MRI_ses-1_dMRI_B2500_S15_MB2_v2_1.txt');

% Perform MoCo-EPI correction and final DTI fit
MRTQuant.PerformMocoEPI('mat_file','sub-MRI_ses-1/dwi/sub-MRI_ses-1_dMRI_B2500_S15_MB2_v2_1_FP_denoised.mat',...
    'epi_tgt','sub-MRI_ses-1/anat/sub-MRI_ses-1_sT1W_3D_TFE_1_brain_FP_ds.nii','fit_mode','wls');

% Export DTI metrics to .nii
MRTQuant.MatMetrics2Nii('sub-MRI_ses-1/dwi/sub-MRI_ses-1_dMRI_B2500_S15_MB2_v2_1_FP_denoised_MD_C_trafo.mat');

% Convert EDTI-like data to the MRIToolkit standard structure
mrt_data = MRTQuant.EDTI_Data_2_MRIToolkit('mat_file','sub-MRI_ses-1/dwi/sub-MRI_ses-1_dMRI_B2500_S15_MB2_v2_1_FP_denoised_MD_C_trafo.mat');
...
MRTTrack.SaveOutputToNii(SD,GRL_Results,'sub-MRI_ses-1/dwi/GRL_deconv');

MRTQuant.PerformFODBased_FiberTracking('mat_file','sub-MRI_ses-1/dwi/sub-MRI_ses-1_dMRI_B2500_S15_MB2_v2_1_FP_denoised_MD_C_trafo.mat',...
...
MRTTrack.TerminateTractsWithFraction('mat_file','sub-MRI_ses-1/dwi/sub-MRI_ses-1_dMRI_B2500_S15_MB2_v2_1_FP_denoised_MD_C_trafo.mat',...

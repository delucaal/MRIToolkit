 # MRIToolkit
![MRIToolkit logo](img/MRIToolkitLogo.png)
 ## What is it?
...
The toolbox is slowly but steadily growing!
###### Ready to use:
...
- [x] **'ExploreDTIInterface'**: I am pleased to announce that MRIToolkit now contains, distributes and develops many functions originally developed as part of [ExploreDTI](www.exploredti.com). They are here available as a consolidated library and are planned to also become command line tools. A big thank to [Alexander Leemans](http://providi-lab.org) and Ben Jeurissen for this! ![Collaboration logo](img/EDTICollaborationLogo.png)

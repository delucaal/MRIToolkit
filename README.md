...
The idea behind MRIToolkit is to integrate [my research output](https://research.umcutrecht.nl/researchers/de-luca/) with existing state-of-the-art methods for (diffusion) MRI processing. 

...
mcc('-m','mrtdcmd.m','-d',output_folder,'-v','-a',MRIToolkit.Elastix.Location,...
    '-a',MRIToolkit.dcm2niix,'-a',which('Grad_dirs_1024.txt'))
mcc('-m','mrtd_preproc.m','-d',output_folder,'-v','-a',MRIToolkit.Elastix.Location,...
    '-a',MRIToolkit.dcm2niix,'-a',which('Grad_dirs_1024.txt'))

...
function [yaw,roll,pitch,traslx,trasly,traslz,determinant] = DW_EddyCorrect(dataname,correction_method,rotate_bvecs,reference_volume,show_plot,parameters_file)
global MRIToolkit;
...
elseif(strcmp(correction_method,'elastix_affine'))
    if(isfield(MRIToolkit,'Elastix'))
        ...
        elastix_cmd = MRIToolkit.Elastix.TransformixCMD;
    else
